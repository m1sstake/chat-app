...
(function(c) {
	...
	c.fn.emojiInit = function(b) {
		...
		if (void 0 == b || 0 >= b.length) option.error(null, "target object is undefined");
			...
			b.after("<div id='faceBlock' style='background:rgb(216, 216, 216);border-radius: 12px;display: none;position: fixed; z-index: 99999;border: 1px solid #e2e2e2;padding: 5px;right: 50px;top: 800px;width: 300px;'>" + a + "</div>");
